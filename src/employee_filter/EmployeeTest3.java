...
public class EmployeeTest3 {
	...
	public static void main(String args[]) {
		...
		Predicate<Employee> edcFilter = (Employee employee) -> employee.getUnit() == unit;
		...
		List<Employee> seniorProfessionals = getEmployeesFilteredBy((Employee employee) -> employee.getExperience() > 10);		
		...
		List<Employee> javaEDC = getEmployeesFilteredBy(javaEdc);		
		

		System.out.println("--------java edc guys--------");
		System.out.println(javaEDC);
