...
public class EmployeeTest2 {
	...
	public static void main(String args[]) {
		...
		List<Employee> allJavaDevelopers = getAllEmployeesFilteredBy(new JavaFilter());
		...
		List<Employee> seniorEmployees = getAllEmployeesFilteredBy(new SeniorProfessionalsFilter());
		System.out.println(seniorEmployees);

	}

	private static List<Employee> getAllEmployeesFilteredBy(EmployeeFilter<Employee> filter) {
