...
public class EmployeeTest4 {
	...
	public static void main(String args[]){
		...
		EmployeeFilter<Employee> edcFilter=  (Employee employee) -> employee.getUnit() == Unit.EDC;
		...
		EmployeeFilter<Employee> javaFilter = (Employee employee) -> employee.getSkills().contains(Skill.JAVA);
	...
	private static EmployeeFilter<Employee> seniorProfessionals(int years){
		return employee -> employee.getExperience() > years  ;
		
	}
	
	public static List<Employee> getEmployeesFilteredBy(EmployeeFilter<Employee> filter) {
